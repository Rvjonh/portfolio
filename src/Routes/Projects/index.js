...
import BookstoreImg from './../../Assets/Projects/bookstore-page.png'
        ...
        <div className='projects-section'>
            ...
            <section className='projects-list'>
                ...
                <div className='projects-container'>
                    ...
                    <ProjectCard title="Full Bookstore app with Django (SSR)"
                        img={BookstoreImg}
                        link="https://django-bookstore.onrender.com/"
                        linkRepository="https://github.com/Rvjonh/django_bookstore"
                        description="This project is a server site rendering (SSR) with django and many third party packages to complete fully apply django and building a complete project with django. This project is a version of the project offered in the book Django for Professionals Production websites with Python Django 4.0 (William Vincent) and is live coded with modifications by me Rvjonh or just Jonh😎."
                        listTechs={["Django", "HTML", "CSS", "Javascript"]}
                        reversed={true}
                    />
